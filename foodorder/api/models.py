...
class User(models.Model):
    ...
    password = models.CharField(max_length=525)
...
class Restaurant(models.Model):
    ...
    owner = models.OneToOneField(DjangoUser, on_delete=models.SET_NULL, null=True, blank=True)
...
class Wishlist(models.Model):
    ...
    def __str__(self):
        return f"{self.user.first_name} wishlist - {self.food.item_name}"
